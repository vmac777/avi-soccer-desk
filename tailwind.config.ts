  ...
  theme: {
    ...
    extend: {
      ...
      colors: {
        ...
        "glow-us": "hsl(var(--glow-action-us))",
        "glow-them": "hsl(var(--glow-action-them))",
        status: {
          hot: "hsl(var(--status-hot))",
          recent: "hsl(var(--status-recent))",
          warm: "hsl(var(--status-warm))",
          cold: "hsl(var(--status-cold))",
          frozen: "hsl(var(--status-frozen))",
          pipeline: "hsl(var(--status-pipeline))",
        },
      },
      borderRadius: {
        lg: "var(--radius)",
      ...
      keyframes: {
        ...
        "flash-green": {
          "0%": { backgroundColor: "hsl(142 71% 45% / 0.3)" },
